...
- [ ] Why would you use class component over function components (removing hooks from the question)? Because class components have state and can use life cycle methods



- [ ] Name three lifecycle methods and their purposes.
render()  it handles the rendering of your component to the UI. 
, componentDidMount() allows the use of setState(). componentDidUpdate() method is updating the DOM in response to prop or state changes.
